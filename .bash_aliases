...
alias cd_wifi="curl -H 'Host: www.ombord.info' \"https://$(netstat -rn |grep -v ::| awk '$1 ~ /^default$/ {print $2}')/hotspot/hotspot.cgi?method=login&username=lab&password=CAEN&realm=lab\" -kIL"
alias cd..='cd ..'
